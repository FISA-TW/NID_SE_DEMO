                    ...
                    <div class="panel-body">
                        <div class="row">
                            <div class="text-center">
                                ...
                                {!! HTML::link('https://zh-tw.gravatar.com/', '透過Gravatar更換大頭貼', ['class' => 'btn btn-primary', 'target' => '_blank']) !!}
                            </div>
                        </div>
                        <hr />
                        <div class="row">
                            {!! Form::open(['route' => 'user.edit-profile', 'class' => 'form-horizontal']) !!}
                                ...
                                <div class="form-group">
                                    <div class="col-md-9 col-md-offset-2">
                                        ...
                                        {!! HTML::linkRoute('user.profile', '返回', null, ['class' => 'btn btn-default']) !!}
                                    </div>
                                </div>
