            ...
            <div class="col-md-10 col-md-offset-1">
                <div class="well bs-component">
                    ...
                    <div class="form-group has-feedback{{ ($errors->has('password'))?' has-error':'' }}">
                        <label class="control-label" for="password">密碼 <a href="{{ URL::route('user.forgot-password') }}" tabindex="4">（忘記密碼）</a>
                    ...
                    <a href="{{ URL::route('user.register') }}" class="btn btn-default">註冊</a>
                    {!! Form::close() !!}
                </div>
            </div>
        </div>
